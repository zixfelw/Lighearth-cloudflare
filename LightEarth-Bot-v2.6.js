...
//
// FEATURES:
// - 📋 Thông báo gọn gàng: 1 dòng mỗi chỉ số
...
const HOURLY_MESSAGES = {
  early_morning: [
    { emoji: '🌅', label: 'SÁNG SỚM' },
    { emoji: '🌤️', label: 'BÌNH MINH' },
    { emoji: '☀️', label: 'EARLY BIRD' }
  ],
  morning: [
    { emoji: '☀️', label: 'BUỔI SÁNG' },
    { emoji: '🌞', label: 'MORNING' },
    { emoji: '✨', label: 'SÁNG NAY' }
  ],
  noon: [
    { emoji: '🌞', label: 'GIỮA TRƯA' },
    { emoji: '🔥', label: 'PEAK HOUR' },
    { emoji: '☀️', label: 'NOONTIME' }
  ],
  afternoon: [
    { emoji: '🌤️', label: 'CHIỀU' },
    { emoji: '☀️', label: 'AFTERNOON' },
    { emoji: '✨', label: 'CHIỀU NAY' }
  ],
  late_afternoon: [
    { emoji: '🌇', label: 'CHIỀU MUỘN' },
    { emoji: '🌆', label: 'SUNSET' },
    { emoji: '✨', label: 'HOÀNG HÔN' }
  ],
  evening: [
    { emoji: '🌙', label: 'TỐI' },
    { emoji: '🌃', label: 'EVENING' },
