/**
 * Device Registration Worker v4.3
 * Auto-register new devices to Home Assistant via Lumentree Integration
 * WITH TELEGRAM APPROVAL FLOW + WEB REAL-TIME STATUS UPDATE
 * 
 * v4.4 Changes:
  ...
  async fetch(request, env) {
    ...
    if (path === '/health' || path === '/') {
      return new Response(JSON.stringify({
        status: 'ok',
        version: '4.4',
        service: 'Device Registration Worker with Telegram Approval + Web Sync',
